...
if geometry_type == "conical" || geometry_type == "bell"
    ...
    x_throat = [x_converging_chamber, x_converging_linear, x_converging_throat, x_diverging];
    y_throat = [y_converging_chamber, y_converging_linear, y_converging_throat, y_diverging];
